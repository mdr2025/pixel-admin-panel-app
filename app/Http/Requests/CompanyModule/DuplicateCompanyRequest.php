...
class DuplicateCompanyRequest extends BaseFormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        if (request()->isMethod('post')) {
            return [
                ...
                'company_domain' => 'required|string|unique:companies,company_domain',
                ...
                'branches_no' => ['nullable', 'integer'],
                //  'package_status' => ['nullable', Rule::in(['Basic', 'Upgraded-no-Due', 'Upgraded-in-Due', 'Upgraded-over-Due'])],
                'package_id' => ['nullable', 'exists:packages,id'],
                'dates' => ['nullable', 'string'],
                'admin_email' => ['required', 'email', 'unique:companies,admin_email', 'unique:users,email'],
